...
namespace Uni.Students.API.Controllers
{
    ...
    public class StudentsController : ControllerBase
    {
        ...
        // GET: api/v1/Students/Filter
        [HttpGet("filter")]
        public async Task<ActionResult<IEnumerable<Student>>> GetFilter([FromQuery] IEnumerable<Guid> studentIds)
        {
